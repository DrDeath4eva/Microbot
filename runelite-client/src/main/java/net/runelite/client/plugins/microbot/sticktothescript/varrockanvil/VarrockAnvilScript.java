        ...
        mainScheduledFuture = scheduledExecutorService.scheduleWithFixedDelay(() -> {
            ...
            switch (state) {
                case SMITHING:
                    ...
                    if (expectingXPDrop && Rs2Player.waitForXpDrop(Skill.SMITHING, 20000)) {
...
//                TileObject anvilTile = Rs2GameObject.findObjectById(AnvilIDs.get(0));
                    ...
                    if (Rs2GameObject.interact(2097)) {
                        ...
                        sleepUntil(() -> Rs2Widget.getWidget(AnvilContainerWidgetID, 1) != null, 20000);
                        sleep(186, 480);
